...
public class DeltaRule extends LearningAlgorithm {
    ...
    @Override 
    public void print(StyledDocument document){
        String msgPrint ="";
        if(learningMode==LearningMode.ONLINE)
            msgPrint = String.format("%7s %4s; %16s %.18f; %13s %.18f\n", "Epoha =",String.valueOf(epoch), " Zapis =" //record
                    ,currentRecord, " Ukupna greška =", overallGeneralError);
        else
            msgPrint = String.format("%7s %4s; %16s %.18f; ", "Epoha =", String.valueOf(epoch), " Ukupna greška =", overallGeneralError );
        if(testingDataSet!=null)
            msgPrint=msgPrint + String.format("%13s %.20f \n", " Test greška =" ,testingOverallGeneralError);
        
        try {
			document.insertString(document.getLength(), msgPrint, null);
...
//            frame.setVisible(true);
	...
	public void train(StyledDocument document) throws NeuralException {
		// TODO Auto-generated method stub
		
	}

	public void showErrorEvolution(JPanel panelErrorEvolution) {
		// TODO Auto-generated method stub
